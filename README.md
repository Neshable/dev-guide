...
* [Using dbsake to recover table structure from .frm](https://www.percona.com/blog/2015/12/16/recovering-table-structure-from-frm-files-using-dbsake/) -  collection of command-line tools that perform various DBA related tasks for MySQL
